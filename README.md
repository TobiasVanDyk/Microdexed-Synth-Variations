...
In additions three Circle-based Raspberry Pi synths namely two variations of the miniDexed Raspberry Pi FM Synth 8xDX7 by [**Probonopd**](https://github.com/probonopd/MiniDexed) using a Waveshare WM8960 DAC Hat and a 6N137 MidiIn, and an MT32-Pi using a Raspberry 3A+ and WM8960 DAC, were built.
