...
It uses the excellent [**snap-close**](images/DHSbuild.png) 3d-printed case [**presented by dhstsw here**](https://github.com/probonopd/MiniDexed/discussions/165), and the top and modified bottom (the trimpot was replaced with a [**6N137 Midi Interface**](6N137Midi.png) and a 5pin DIN socket added) STL files are in the STL folder. The modified case here is still a WIP. 
